...
def main():
    ...
    try:
        ...
        while True:
            ...
            list_value.insert(0,
                              current_date_time)  # inserted the datetime, INPLACE. So list_value actully includes the datetime.
            ...
            df_current_value = pd.DataFrame({'Sensor_ID': range(100, 227), 'Sensor_reading': value})  # try with tuple
